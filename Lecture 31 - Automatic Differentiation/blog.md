# Lecture 31 — Automatic Differentiation
    ...
    **[📓 Open the notebook on GitHub](https://github.com/manish7725/deeplearning/blob/main/Lecture%2031%20-%20Automatic%20Differentiation/notebook.ipynb)**  · **[▶ Open in Google Colab](https://colab.research.google.com/github/manish7725/deeplearning/blob/main/Lecture%2031%20-%20Automatic%20Differentiation/notebook.ipynb)**

    ## 🧭 Where this lesson fits

**Previous lesson:** Blog 20 — Build a Tiny Neural Network From Scratch.

**Today:** Blog 21 — Automatic Differentiation.

**Next lesson:** Blog 22 — Can a Neural Network Learn Any Shape?.

**Student rule:** understand the story first, then the equation, then the code.

    ## 1. The idea in one sentence

    A computer can turn a chain of tiny operations into a chain of local derivatives.
    ...
    **Three questions:**
    ...
    For z = x^2 and L = 3z, dz/dx = 2x and dL/dx = 3(2x). The chain rule multiplies local slopes.
    ...
    Use finite differences to check an analytical derivative, then compare the same derivative with PyTorch autograd.
    ...
    **Failure mode:** Change the finite-difference step size. Very large or very tiny steps can make the numerical estimate worse.
