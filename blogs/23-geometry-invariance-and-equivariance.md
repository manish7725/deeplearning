# Blog 23 — Geometry, Invariance, and Equivariance
    ...
    **[📓 Open the notebook on GitHub](https://github.com/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/23-geometry-invariance-and-equivariance.ipynb)**  · **[▶ Open in Google Colab](https://colab.research.google.com/github/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/23-geometry-invariance-and-equivariance.ipynb)**

    ## 🧭 Where this lesson fits

**Previous lesson:** Blog 22 — Neural Networks as Function Approximators.

**Today:** Blog 23 — Geometry, Invariance, and Equivariance.

**Next lesson:** Blog 24 — When Data Looks Like a Network: Graph Neural Networks.

**Student rule:** understand the story first, then the equation, then the code.

    ## 1. The idea in one sentence

    Some transformations should not change an answer, while others should change the answer in a predictable way.
    ...
    **Three questions:**
    ...
    Invariance means f(Tx)=f(x). Equivariance means f(Tx)=T'f(x). Rotation is a simple transformation matrix example.
    ...
    Rotate a set of points and compare distances before and after transformation. Test a quantity that should be invariant.
    ...
    **Failure mode:** A model can memorize positions instead of learning the underlying symmetry.
