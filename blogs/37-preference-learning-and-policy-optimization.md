# Blog 37 — Preference Learning and Policy Optimization
    ...
    **[📓 Open the notebook on GitHub](https://github.com/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/37-preference-learning-and-policy-optimization.ipynb)**  · **[▶ Open in Google Colab](https://colab.research.google.com/github/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/37-preference-learning-and-policy-optimization.ipynb)**

    ## 🧭 Where this lesson fits

**Previous lesson:** Blog 36 — Metrized Deep Learning.

**Today:** Blog 37 — Preference Learning and Policy Optimization.

You have reached the end of the current learning path.

**Student rule:** understand the story first, then the equation, then the code.

    ## 1. The idea in one sentence

    A model can be trained from choices such as 'answer A is better than answer B'.
    ...
    **Three questions:**
    ...
    A simple pairwise preference model uses L=-log sigma(r_winner-r_loser), where r is a learned reward and sigma is the logistic function.
    ...
    Fit rewards to a small set of pairwise preferences and inspect whether the preferred item receives the larger score.
    ...
    **Failure mode:** Optimizing a proxy reward can exploit weaknesses in the reward model; preference data can also be noisy or inconsistent.
