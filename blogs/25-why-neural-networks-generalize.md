# Blog 25 — Why Neural Networks Generalize
    ...
    **[📓 Open the notebook on GitHub](https://github.com/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/25-why-neural-networks-generalize.ipynb)**  · **[▶ Open in Google Colab](https://colab.research.google.com/github/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/25-why-neural-networks-generalize.ipynb)**
...
**Next lesson:** Blog 26 — What Happens When We Make Training Bigger?.

**Student rule:** understand the story first, then the equation, then the code.

    ## 1. The idea in one sentence

    Learning is useful only if the model works beyond the examples it memorized.
    ...
    **Three questions:**
    ...
    Training minimizes empirical risk R_hat(f)=1/n sum_i L(f(x_i),y_i); generalization asks how close this is to population risk R(f)=E[L].
    ...
    Create a train/test split and plot both losses across training. Watch for a growing generalization gap.
    ...
    **Failure mode:** A very low training loss is not evidence of good performance on unseen data.
