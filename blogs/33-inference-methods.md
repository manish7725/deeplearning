# Blog 33 — Inference Methods
    ...
    **[📓 Open the notebook on GitHub](https://github.com/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/33-inference-methods.ipynb)**  · **[▶ Open in Google Colab](https://colab.research.google.com/github/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/33-inference-methods.ipynb)**

    ## 🧭 Where this lesson fits

**Previous lesson:** Blog 32 — Scaling Laws.

**Today:** Blog 33 — Inference Methods.

**Next lesson:** Blog 34 — The Detective's Guide to Training a Neural Network.

**Student rule:** understand the story first, then the equation, then the code.

    ## 1. The idea in one sentence

    A trained model produces scores; a decoding rule decides what answer actually comes out.
    ...
    **Three questions:**
    ...
    Temperature changes probabilities by p_i=softmax(z_i/T). Greedy chooses argmax; top-k keeps k candidates; top-p keeps the smallest probability mass whose cumulative probability reaches p.
    ...
    Use the same logits with several temperatures and implement greedy and top-k choices.
    ...
    **Failure mode:** Sampling is not the same as improving the model. A decoding trick can change outputs without changing learned parameters.
