# Blog 29 — Conditional Generative Models
    ...
    **[📓 Open the notebook on GitHub](https://github.com/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/29-conditional-generative-models.ipynb)**  · **[▶ Open in Google Colab](https://colab.research.google.com/github/manish7725/deeplearning/blob/reorg/class8-to-phd-curriculum/notebooks/29-conditional-generative-models.ipynb)**

    ## 🧭 Where this lesson fits

**Previous lesson:** Blog 28 — Contrastive Learning.

**Today:** Blog 29 — Conditional Generative Models.

**Next lesson:** Blog 30 — What Happens When the World Changes?.

**Student rule:** understand the story first, then the equation, then the code.

    ## 1. The idea in one sentence

    Generation becomes controllable when the model receives a condition describing what it should produce.
    ...
    **Three questions:**
    ...
    The target is a conditional distribution p(x|c). A useful model learns the relationship between condition c and generated sample x rather than only p(x).
    ...
    Generate numbers from two different conditional groups and compare their empirical means and variances.
    ...
    **Failure mode:** A generator may ignore the condition; this is called condition leakage or conditioning failure depending on the setup.
